...
- **Changelog:** `docs/Manual/CHANGELOG.md` — user-facing changes per released version, written in German (published on the manual site at https://autonumber.niggl-schlagbauer.de/CHANGELOG/)
