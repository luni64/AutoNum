...
The full manual (installation, all features, tips, FAQ) is available in the **[User Manual (MANUAL_EN.md)](docs/Manual/MANUAL_EN.md)**.
...
All versions and their changes are listed in the [changelog](docs/release/CHANGELOG.md).
